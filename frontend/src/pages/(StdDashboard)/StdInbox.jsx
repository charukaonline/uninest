...
const ChatInterface = ({ user }) => {
    const [messages, setMessages] = useState([
        ...
        { id: 3, text: "I'm good, thanks for asking!", time: "11:52", sender: "other" },
        { id: 4, text: "Can you help me with something?", time: "11:53", sender: "other" },
                ...
                <div className="flex justify-between w-full h-fulFl gap-4">
                    ...
                    <div className="w-1/4 bg-white rounded-lg shadow-md p-4 px-2 overflow-hidden">
                        ...
                        <ScrollArea className="h-[calc(100vh-100px)]">
                            <div className='mt-5'>
                                <div className='flex items-center space-x-3 mb-4 hover:bg-gray-100 rounded-md w-full p-1 py-2 px-2 cursor-pointer'
                                    onClick={() => handleChatSelect({ name: 'John Doe', avatar: 'https://via.placeholder.com/150' })}>
                                    <img src="https://via.placeholder.com/150" alt="Profile" className="w-12 h-12 rounded-full bg-purple-400 flex-shrink-0" />
                                    <div className="min-w-0">
                                        <h1 className="font-semibold truncate text-primaryBgColor">John Doe</h1>
                                        <div className='flex items-center space-y-0 space-x-1'>
                                            <MessageStatus status="read" />
                                            <p className="text-gray-600">
                                                {truncateText("Hello, how are you? ugygyugygygugygyugygyg")}
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className='flex items-center space-x-3 mb-4 hover:bg-gray-100 rounded-md w-full p-1 py-2 px-2 cursor-pointer'
                                    onClick={() => handleChatSelect({ name: 'Alice Smith', avatar: 'https://via.placeholder.com/150' })}>
                                    <img src="https://via.placeholder.com/150" alt="Profile" className="w-12 h-12 rounded-full bg-purple-400 flex-shrink-0" />
                                    <div className="min-w-0">
                                        <h1 className="font-semibold truncate text-primaryBgColor">Alice Smith</h1>
                                        <div className='flex items-center space-y-0 space-x-1'>
