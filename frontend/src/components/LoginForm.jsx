        ...
        {isLogin ? (
          ...
          <div className="flex flex-col justify-center p-10">
            ...
            <form onSubmit={handleLoginSubmit}>
              <div className="py-2">
                <label className="text-sm text-white">User name or email address</label>
                <input
                  type="email"
                  name="email"
              ...
              <div className="flex justify-end mb-6">
                <button className="text-sm font-semibold text-white hover:underline">Forgot your password?</button>
              </div>
