...
function HeroSection() {
  return (
    <section className="flex flex-col items-center justify-center bg-[url('/src/assets/Project.jpg')] bg-cover bg-center bg-no-repeat py-16 px-8 lg:px-20 font-sans">
      ...
      <div className="max-w-xl space-y-9 lg:space-y-8 text-center">
        ...
        <div className="space-y-5 px-4">
          ...
          >
            Find Your Favorite <span className="text-green-700">Boarding House</span>
          </h1>
          <p className="text-gray-700 text-lg leading-relaxed">
            Discover great options to buy or rent boarding houses tailored for university students across Sri Lanka.
          </p>
        </div>
        ...
        <div className="w-full mx-auto lg:max-w-lg lg:bg-white rounded-lg lg:p-4 p-0">
          <div className="flex flex-col lg:flex-row items-center lg:space-x-4">
            ...
            {/* Divider (|) */}
            <div className="lg:h-6 w-px bg-gray-300 mx-4"></div> {/* Divider with spacing */}
