  ...
  return (
    <div className=" bg-gray-100">
      <div className=" mx-auto p-8 px-10 grid grid-cols-1 md:grid-cols-4 gap-8 text-center md:text-left">
        ...
        <div className=" flex justify-center items-start">
          <div className="space-y-2">
            <h2 className="font-semibold text-md text-gray-800 mb-3">
              TERMS & PRIVACY
            </h2>
            <Link
              to="/"
      ...
      <div className="bg-[#006845] text-center text-white flex justify-between p-4 px-10">
        ...
        <div className="flex justify-center md:justify-start space-x-6">
          <Link to="/">
            <FaFacebookF className="text-white hover:text-[#eee] size-5" />
          </Link>
          <Link to="/">
            <FaInstagram className="text-white hover:text-[#eee] size-5" />
          </Link>
          <Link to="/">
            <FaTwitter className="text-white hover:text-[#eee] size-5" />
          </Link>
          <Link to="/">
            <FaLinkedin className="text-white hover:text-[#eee] size-5" />
          </Link>
        </div>
      </div>
    </div>
