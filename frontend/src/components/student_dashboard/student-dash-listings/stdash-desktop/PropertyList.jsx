...
const houseImage = "/UserDashboardimg/Image.png?url";
const houseImage1 = "/assets/HouseOwnerDashboard-img/Image (1).png?url";
const houseImage2 = "/assets/HouseOwnerDashboard-img/Image (2).png?url";
const houseImage3 = "/assets/HouseOwnerDashboard-img/Image (3).png?url";
const houseImage4 = "/assets/HouseOwnerDashboard-img/Image (4).png?url";
