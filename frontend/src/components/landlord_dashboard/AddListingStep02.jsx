            ...
            >
                <div className='w-full'>
                    <div className='bg-white p-8 rounded-xl shadow-lg'>
                        <h2 className='text-3xl font-semibold text-gray-800 mb-8 border-b pb-4'>Add House Location</h2>
                        ...
                        <div className='grid grid-cols-1 lg:grid-cols-3 gap-x-12 gap-y-6'>
                            ...
                            <div className='space-y-4'>
                                ...
                                <Form.Item
                                    label={<span className='text-base font-medium'>Zip/Postal Code</span>}
                                    name="postalCode"
                                >
                                    <Input className="w-full h-10" placeholder='Boarding house postal code' />
                                </Form.Item>

                                <Form.Item
                                    label={<span className='text-base font-medium'>Which university is near the dormitory?</span>}
                                    name="nearest-university"
                                    rules={[{ required: true, message: "Please enter nearest university!" }]}
                                >
                                    <Input className="w-full h-10" placeholder='University Proximity (km)' />
                                </Form.Item>
                            </div>
                            ...
                            <div className='space-y-4 w-full'>
                                ...
                                {/* Map here */}
                                <Form.Item
                                    label={<span className='text-base font-medium'>Select dormitory location on Map</span>}
                                    name="coordinates"
                                ...
                                >
                                    <div className="h-[420px] w-full">
                                        <Map 
                                            ...
                                            selectedLocations={selectedCoordinates ? [selectedCoordinates] : []}
                                        ...
                                        {selectedCoordinates && (
                                            <div className="mt-2 p-2 bg-gray-50 rounded">
                                                <p className="text-sm text-gray-600">
                                                    Selected Location: {selectedCoordinates.latitude.toFixed(6)}, {selectedCoordinates.longitude.toFixed(6)}
                                                </p>
                                            </div>
                                        )}
                                    </div>
