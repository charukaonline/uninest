...
// Update the component definition to accept the onContactLandlord prop
const ListingInfoHeroSection = ({ listing, onContactLandlord }) => {
        ...
        <div className=" flex space-x-2 mt-2">
          ...
          <div className=" p-4 rounded-lg w-1/3 bg-primaryBgColor">
            ...
            <button
              ...
              className="w-full mt-4 py-2 bg-white text-primaryBgColor rounded-md hover:bg-gray-100 transition font-semibold flex items-center justify-center"
            >
              <svg
